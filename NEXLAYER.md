...
**Live:** [https://relaxed-weasel-sakuli.cloud.nexlayer.ai](https://relaxed-weasel-sakuli.cloud.nexlayer.ai)  
...
**sakuli** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/consol/sakuli-ubuntu-xfce:latest
    path: /
    servicePorts:
    - 6901
    vars:
